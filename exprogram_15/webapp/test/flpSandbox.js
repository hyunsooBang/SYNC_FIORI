		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Program (15)",
									"targetURL": "#examexprogram15-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogram15-display": {
								"semanticObject": "examexprogram15",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogram15",
									"url": sap.ui.require.toUrl("exam/exprogram15")
								}
							}
						}
					}
