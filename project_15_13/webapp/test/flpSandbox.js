		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData CRUD",
									"targetURL": "#odataproject1513-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odataproject1513-display": {
								"semanticObject": "odataproject1513",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odata.project1513",
									"url": sap.ui.require.toUrl("odata/project1513")
								}
							}
						}
					}
