		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX400 문제",
									"targetURL": "#sapbtpux400solving15-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpux400solving15-display": {
								"semanticObject": "sapbtpux400solving15",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.ux400solving15",
									"url": sap.ui.require.toUrl("sap/btp/ux400solving15")
								}
							}
						}
					}
