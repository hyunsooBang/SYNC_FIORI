		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX410 문제",
									"targetURL": "#sapbtpux410solving15-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpux410solving15-display": {
								"semanticObject": "sapbtpux410solving15",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.ux410solving15",
									"url": sap.ui.require.toUrl("sap/btp/ux410solving15")
								}
							}
						}
					}
